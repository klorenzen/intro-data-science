...
},
{
  "id": "exercise-1",
  "level": "2",
  "url": "section-1-2.html#exercise-1",
  "type": "Exercise",
  "number": "1.2.1",
  "title": "",
  "body": "For each of the ways that gather is collected around you, brainstorm possible data science questions that are future looking, observable, and have un-obvious solutions.  Number of pictures a person posts a day on a social media site.  Number of times people searched for a particular word each day over several years.  The number of webpages written in every language.  Answers to survey results sent out to thousands of people.  Number of times a particular player tries to score and the number of times they are successful.   "
},
{
  ...
  "type": "Section",
  "number": "2.1",
  "title": "Transparency of algorithms",
  "body": " Transparency of algorithms  "
},
{
  "id": "section-2-2",
  "level": "1",
  ...
  "type": "Section",
  "number": "2.2",
  "title": "Dangers of scaling",
  "body": " Dangers of scaling  "
},
{
  "id": "section-2-3",
  "level": "1",
  ...
  "type": "Section",
  "number": "2.3",
  "title": "Fairness - using data for good.",
  "body": " Fairness - using data for good.  Check bias that inevitably ends up in algorithms.  "
},
{
  "id": "section-2-4",
  "level": "1",
  ...
  "type": "Section",
  "number": "2.4",
  "title": "Ethical collection of data and use of personal data.",
  "body": " Ethical collection of data and use of personal data.  "
},
{
  "id": "section-2-5",
  "level": "1",
  ...
  "body": " Accountability  Who is accountable? Consumers, programmers, or government?  "
},
{
  "id": "section-3-1",
  "level": "1",
